...
deploy-dasset:; forge script script/DeployOnlyDAsset.s.sol --sender 0x34F1AF42413326d1255bf02B5402737C10fFbC6a --account devKey --rpc-url ${SEPOLIA_RPC_URL} --etherscan-api-key ${ETHERSCAN_API_KEY} --verify --broadcast
